...
public class HeaderFooterTable {
    ...
    public static void main(String[] args) throws IOException {
        try (XWPFDocument doc = new XWPFDocument()) {
            ...
            tbl.setInsideHBorder(XWPFTable.XWPFBorderType.NONE,0,0,null);
            tbl.setInsideVBorder(XWPFTable.XWPFBorderType.NONE,0,0,null);

            CTTblPr tblpro = tbl.getCTTbl().getTblPr();
...
//also inner borders
            ...
            try (OutputStream os = new FileOutputStream(new File("C:\\Rajesh\\Sample\\headertable.docx"))) {
                doc.write(os);
            }
        }
    }
